...
ComponentPurposeRaw Data sheetSource data: Emp Code, Sales Executive, Region, Day1–Day5, Total Sales, Target, Target Hit %, Away From Target %Dashboard sheet4 pivot tables + pivot charts summarizing performance by region and executiveSlicer (Region)Single interactive filter shared across the dashboard viewsVBA MacrosAutomate slicer connections and keep the dashboard title in sync with the current filter
